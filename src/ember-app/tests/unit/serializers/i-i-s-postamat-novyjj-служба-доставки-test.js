...
moduleForModel('i-i-s-postamat-novyjj-служба-доставки', 'Unit | Serializer | i-i-s-postamat-novyjj-служба-доставки', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-postamat-novyjj-служба-доставки',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
