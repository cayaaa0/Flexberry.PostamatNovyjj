...
namespace IIS.PostamatNovyjj
{
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.PostamatNovyjj.Состояние fСостояние;
        ...
        public virtual IIS.PostamatNovyjj.Состояние Состояние
        {
            get
            {
                ...
                IIS.PostamatNovyjj.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.PostamatNovyjj.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.PostamatNovyjj.Логистика));
                }
            }
        }
    }
