...
namespace IIS.PostamatNovyjj
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.PostamatNovyjj.Оплата fОплата;
        ...
        public virtual IIS.PostamatNovyjj.Оплата Оплата
        {
            get
            {
                ...
                IIS.PostamatNovyjj.Оплата result = this.fОплата;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.PostamatNovyjj.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.PostamatNovyjj.Транзакция));
                }
            }
        }
    }
